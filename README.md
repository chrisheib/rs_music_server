...
The download step prefers `bestaudio/best`, falls back to broader `yt-dlp` selectors when needed, and `ensure_mp3` converts non-MP3 downloads to MP3 via `ffmpeg` before normalization.
